...
To accomplish this goals, the following specific objectives are established:

\begin{itemize}
    \item \textbf{Analytical Formulation:} Formulate a Linear Stability Analysis (LSA) for the multiphase displacement involving a magnetic fluid under an external magnetic field to derive the theoretical stability criteria and the perturbation dispersion relations.
    
    \item \textbf{Computational Modeling:} Develop and verify a multiphase CFD model (e.g., Volume of Fluid or Phase Field) to simulate the nonlinear displacement of heavy oil by a magnetic fluid within a representative porous medium geometry.
